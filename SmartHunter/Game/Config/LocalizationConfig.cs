...
namespace SmartHunter.Config
{
    ...
    public class LocalizationConfig_zhTW
    {
        ...
        public Dictionary<string, string> Strings = new Dictionary<string, string>()
        {
            ...
            { "LOC_PART_HEAD_SNOW", "頭部覆雪" },
            { "LOC_PART_BODY_SNOW", "軀幹覆雪" },
            { "LOC_PART_TAIL_SNOW", "尾部覆雪" },

            { "LOC_PART_HEAD_ICE", "頭部冰甲" },
            { "LOC_PART_BODY_ICE", "軀幹冰甲" },
            { "LOC_PART_WINGS_ICE", "雙翼冰甲" },
            { "LOC_PART_ARMS_ICE", "前臂冰甲" },
            { "LOC_PART_LEGS_ICE", "雙腳冰甲" },
            { "LOC_PART_TAIL_ICE", "尾部冰甲" },

            { "LOC_PART_HEAD_ROCK", "頭部岩石" },
            { "LOC_PART_NECK_LEFT_ROCK", "左頸岩石" },
            { "LOC_PART_NECK_RIGHT_ROCK", "右頸岩石" },
            { "LOC_PART_TAIL_ROCK", "尾部岩石" },
            { "LOC_PART_WING_LEFT_ROCK", "左翼岩石" },
            { "LOC_PART_WING_RIGHT_ROCK", "右翼岩石" },
            { "LOC_PART_ARM_LEFT_ROCK", "左臂岩石" },
            { "LOC_PART_ARM_RIGHT_ROCK", "右臂岩石" },
            { "LOC_PART_LEGS_ROCK", "雙足岩石" },
            ...
            { "LOC_STATUS_EFFECT_MUCK_RESISTANCE", "泥/水/深雪減輕" },
            ...
            { "LOC_STATUS_EFFECT_BLIGHT_RESISTANCE_UP", "屬性異常狀態耐性UP" },
            ...
            { "LOC_STATUS_EFFECT_MAX_STAM_UP_REC", "最大耐力上限/回復" },
            { "LOC_STATUS_EFFECT_EXT_HEALTH_REC", "Extended Health Recovery" },
            { "LOC_STATUS_EFFECT_SPEED_BOOST_EVADE_UP", "Speed Boost / Evade Window Up" },
            { "LOC_STATUS_EFFECT_ELE_EFF_UP", "Elemental Effectiveness Up" },

            // Orchestra
            { "LOC_STATUS_EFFECT_RESUSCITATE", "死裡逃生" },
            ...
            { "LOC_EQUIPMENT_CLEANSER_BOOSTER", "解除煙筒" },
            ...
            { "LOC_EQUIPMENT_RECHARGE_CLEANSER_BOOSTER", "解除煙筒" },
