...
namespace SmartHunter.Game.Config
{
    public class PlayerDataConfig
    {
        ...
        public StatusEffectConfig[] StatusEffects =
        {
            ...
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_STUN_NEGATED", (uint)StatusEffectConfig.MemorySource.Base, indexToHexStrNoOffset(82)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_PARALYSIS_NEGATED", (uint)StatusEffectConfig.MemorySource.Base, indexToHexStrNoOffset(83)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_TREMORS_NEGATED", (uint)StatusEffectConfig.MemorySource.Base, indexToHexStrNoOffset(84)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_EARPLUGS_S", (uint)StatusEffectConfig.MemorySource.Base, indexToHexStrNoOffset(85)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_WIND_PRESSURE_NEGATED", (uint)StatusEffectConfig.MemorySource.Base, indexToHexStrNoOffset(86)),
            new StatusEffectConfig("Coral", "LOC_STATUS_EFFECT_ENVIRONMENTAL_DAMAGE_NEGATED", (uint)StatusEffectConfig.MemorySource.Base, indexToHexStrNoOffset(87)),
