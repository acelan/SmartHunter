...
namespace SmartHunter.Core.Helpers
{
    public class Updater
    {
        ...
        private readonly string _apiEndpoint = "https://api.github.com/repos/acelan/SmartHunter/commits?path=";
        private readonly string _apiRaw = "https://github.com/acelan/SmartHunter/raw";
